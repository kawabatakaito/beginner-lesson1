...
class CreateDailyDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('daily_details', function (Blueprint $table) {
            ...
            $table->unsignedInteger('daily_id')->nullable(false);
            ...
            $table->integer('workers_number')->nullable(false);
            ...
            $table->time('started_on')->nullable(false);
            $table->time('finished_on')->nullable(false);
